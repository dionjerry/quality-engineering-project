...
- Part 2 currently contains only the local service and API availability foundation; authentication, CRUD, validation, filtering, and defect coverage are not yet included.
